...
h5,
h6 {
    font-family: "Lucida Grande", "Corbal", sans-serif;
    font-weight: normal;
    clear: both;
...
#write>.md-fences.md-focus:before,
#write>.md-fences.md-focus:after {
  position: absolute;
  font-size: 10px;
  z-index: 99;
  color: #999;
...
#write>.md-fences.md-focus:before{content: "``` " attr(lang); top: 5px;}
#write>.md-fences.md-focus:after {content: "```"; bottom: -5px;}
